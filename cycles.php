...
<p><b><a href="http://homework.local/?url=cycles&flag=1">1. Дан массив с элементами 'html', 'css', 'php', 'js', 'jq'. С помощью цикла foreach выведите эти слова в столбик.</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=2">2. Дан массив с элементами 1, 20, 15, 17, 24, 35. С помощью цикла foreach найдите сумму элементов этого массива. Запишите ее в переменную \$result.</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=3">3. Дан массив с элементами 26, 17, 136, 12, 79, 15. С помощью цикла foreach найдите сумму квадратов элементов этого массива. Результат запишите переменную \$result.</a></b></p>

<b>Работа с ключами</b>

<p><b><a href="http://homework.local/?url=cycles&flag=4">4. Дан массив \$arr. С помощью первого цикла foreach выведите на экран столбец ключей, с
помощью второго — столбец элементов.
\$arr = array('green'=>'зеленый', 'red'=>'красный','blue'=>'голубой');</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=5">5. Дан массив \$arr с ключами 'Коля', 'Вася', 'Петя' с элементами '200', '300', '400'. С помощью
цикла foreach выведите на экран столбец строк такого формата: 'Коля — зарплата 200
долларов.'.</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=6">6. Дан массив \$arr. С помощью цикла foreach запишите английские названия в массив \$en, а
русские — в массив \$ru.
\$arr = array('green'=>'зеленый', 'red'=>'красный','blue'=>'голубой');
\$en = array('green', 'red','blue');
\$ru = array('зеленый', 'красный', 'голубой');</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=7">7. Дан массив с элементами 2, 5, 9, 15, 0, 4. С помощью цикла foreach и оператора if
выведите на экран столбец тех элементов массива, которые больше 3­х, но меньше 10</a></b>.</p>
<p><b><a href="http://homework.local/?url=cycles&flag=8">8. Дан массив с элементами 1, 2, 3, 4, 5, 6, 7, 8, 9. С помощью цикла foreach создайте строку
'­1­2­3­4­5­6­7­8­9­'.
Циклы while и for</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=9">9. Выведите столбец чисел от 1 до 100.</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=10">10. Выведите столбец чисел от 11 до 33.</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=11">11. Выведите столбец четных чисел в промежутке от нуля до 100.</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=12">12. Дано число \$n = 1000. Делите его на 2 столько раз, пока результат деления не станет
...
<p><b><a href="http://homework.local/?url=cycles&flag=13">13. Вывести таблицу умножения</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=14">14. Дан массив с элементами 4, 2, 5, 19, 13, 0, 10. С помощью цикла foreach и оператора if
проверьте есть ли в массиве элемент со значением \$e, равном 2, 3 или 4. Если есть —
выведите на экран 'Есть!', иначе выведите 'Нет!'.</p>
<p><b><a href="http://homework.local/?url=cycles&flag=15">15. Дан массив \$arr. С помощью цикла foreach и переменной \$count подсчитайте количество
элементов этого массива. Проверьте работу скрипта на примере массива с элементами 4, 2,
5, 19, 13, 0, 10.</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=16">16. Дан массив с элементами 1, 2, 3, 4, 5, 6, 7, 8, 9. С помощью цикла foreach и оператора if
выведите на экран столбец элементов массива, как показано на картинке.
1, 2, 3
4, 5, 6
7, 8, 9</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=17">17.Сосктавьте массив месяцев. С помощью цикла foreach выведите все месяцы, а текущий
месяц выведите жирным. Текущий месяц должен храниться в переменной \$month.</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=18">18. Составьте массив дней недели. С помощью цикла foreach выведите все дни недели,
выходные дни следует вывести жирным.</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=19">19. Составьте массив дней недели. С помощью цикла foreach выведите все дни недели, а
текущий день выведите курсивом. Текущий день должен храниться в переменной \$day.</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=20">20.Нарисуйте пирамиду, как показано на рисунке, только у вашей пирамиды должно быть 20
рядов, а не 5.<br><br>
x<br>
xx<br>
xxx<br>
xxxx<br>
xxxxx</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=21">21. Нарисуйте пирамиду, как показано на рисунке, только у вашей пирамиды должно быть 9
рядов, а не 5.<br><br>
1<br>
22<br>
333<br>
4444<br>
55555</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=22">22. Нарисуйте пирамиду, как показано на рисунке, воспользовавшись циклом for или while.<br><br>
xx<br>
xxxx<br>
xxxxxx<br>
xxxxxxxx<br>
xxxxxxxxxx</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=23">23. Вам нужно разработать программу, которая считала бы сумму цифр числа введенного
пользователем. Например: есть число 123, то программа должна вычислить сумму цифр 1,
2, 3, т. е. 6.</a></b></p>
По желанию можете сделать проверку на корректность введения данных пользователем.
<p><b><a href="http://homework.local/?url=cycles&flag=24">24. Вам нужно разработать программу, которая считала бы количество вхождений
какой­нибуть выбранной вами цифры в выбранном вами числе. Например: цифра 5 в числе
442158755745 встречается 4 раза.</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=25">25. Ваше задание создать массив, наполнить это случайными значениями (функция rand),
найти максимальное и минимальное значение и поменять их местами.</a></b></p>
<p><b><a href="http://homework.local/?url=cycles&flag=26">26. Вам нужно создать массив и заполнить его случайными числами от 1 до 100 (ф­я rand).
...
<p><b><a href="http://homework.local/?url=cycles&flag=28">28. Вывести простые числа.</a></b></p>
